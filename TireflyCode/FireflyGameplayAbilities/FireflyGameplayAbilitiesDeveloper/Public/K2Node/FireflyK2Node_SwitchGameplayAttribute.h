...
#include "FireflyK2Node_SwitchGameplayAttribute.generated.h"

// Switch on Gameplay Attribute node
// 游戏属性开关节点
UCLASS(MinimalAPI)
class UFireflyK2Node_SwitchGameplayAttribute : public UK2Node_Switch
{
	GENERATED_BODY()
...
public:
	UFireflyK2Node_SwitchGameplayAttribute(const FObjectInitializer& ObjectInitializer);
