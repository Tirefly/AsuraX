...
#include "K2Node.h"
#include "TireflyK2Node_GetAbilityParameter.generated.h"
...
UCLASS()
class FIREFLYGAMEPLAYABILITIESDEVELOPER_API UK2Node_GetAbilityParameter : public UK2Node
{
	GENERATED_BODY()
...
public:
	...
	// 内部使用的重新创建变体结果输出引脚
	void RecreateVariantPinsInternal(const UFireflyGameplayAbilityAsset* Asset, const FName& Parameter);
	...
	// 根据能力资产来源引脚获取能力资产
	UFireflyGameplayAbilityAsset* GetAbilityAsset(UEdGraphPin* Pin = nullptr) const;
