...
#include "ArenaEnemyController.generated.h"


class UAllianceManagerComponent;
class AArenaAllianceCharacter;
enum class ELegendGameStage : uint8;


// 敌人阵营的控制器
UCLASS()
class LEGENDSTD_API AArenaEnemyController : public AAIController
...
public:
	AArenaEnemyController(const FObjectInitializer& ObjectInitializer);
