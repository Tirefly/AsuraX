...
public:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Meta = (EditCondition = "MinValueType == ETireflyAttributeRangeType::Numeric", EditConditionHides))
	float MinValue = 0.f;

	// 最小值类型为属性时，属性拥有者的指定类型属性值作为属性的范围最小值
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Meta = (EditCondition = "MinValueType == ETireflyAttributeRangeType::Attribute", EditConditionHides))
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Meta = (EditCondition = "MaxValueType == ETireflyAttributeRangeType::Numeric", EditConditionHides))
	float MaxValue = 0.f;

	// 最大值类型为属性时，属性拥有者的指定类型属性值作为属性的范围最大值
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Meta = (EditCondition = "MaxValueType == ETireflyAttributeRangeType::Attribute", EditConditionHides))
