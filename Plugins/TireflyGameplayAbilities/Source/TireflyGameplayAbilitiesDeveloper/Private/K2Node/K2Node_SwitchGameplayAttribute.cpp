...
#include "K2Node/K2Node_SwitchGameplayAttribute.h"
...
UK2Node_SwitchGameplayAttribute::UK2Node_SwitchGameplayAttribute(const FObjectInitializer& ObjectInitializer)
...
void UK2Node_SwitchGameplayAttribute::PostEditChangeProperty(struct FPropertyChangedEvent& PropertyChangedEvent)
{
	// 标志是否已修改
	...
	if (PropertyName == GET_MEMBER_NAME_CHECKED(UK2Node_SwitchGameplayAttribute, PinAttributes) || PropertyName == FName("AttributeName"))
	{
		bIsDirty = true;
	}
