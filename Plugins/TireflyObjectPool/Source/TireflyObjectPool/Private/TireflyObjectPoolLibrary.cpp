...
void UTireflyObjectPoolLibrary::UniversalBeginPlay_Actor(const UObject* WorldContextObject, AActor* Actor)
{
...
void UTireflyObjectPoolLibrary::UniversalEndPlay_Actor(const UObject* WorldContextObject, AActor* Actor)
{
...
void UTireflyObjectPoolLibrary::UniversalWarmUp_Actor(const UObject* WorldContextObject, AActor* Actor)
{
	UniversalEndPlay_Actor(WorldContextObject, Actor);
}

void UTireflyObjectPoolLibrary::UniversalBeginPlay_Pawn(const UObject* WorldContextObject, APawn* Pawn)
{
...
void UTireflyObjectPoolLibrary::UniversalEndPlay_Pawn(const UObject* WorldContextObject, APawn* Pawn)
{
...
void UTireflyObjectPoolLibrary::UniversalWarmUp_Pawn(const UObject* WorldContextObject, APawn* Pawn)
{
	UniversalWarmUp_Actor(WorldContextObject, Pawn);
}

void UTireflyObjectPoolLibrary::UniversalBeginPlay_Character(const UObject* WorldContextObject, ACharacter* Character)
{
	UniversalBeginPlay_Pawn(WorldContextObject, Character);
}

void UTireflyObjectPoolLibrary::UniversalEndPlay_Character(const UObject* WorldContextObject, ACharacter* Character)
{
	UniversalEndPlay_Pawn(WorldContextObject, Character);
}

void UTireflyObjectPoolLibrary::UniversalWarmUp_Character(const UObject* WorldContextObject, ACharacter* Character)
{
