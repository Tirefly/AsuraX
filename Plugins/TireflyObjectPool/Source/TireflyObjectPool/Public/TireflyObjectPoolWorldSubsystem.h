...
#include "TireflyObjectPoolWorldSubsystem.generated.h"

/** 基于世界的对象池子系统 */
/** World based object pool subsystem */
UCLASS()
class TIREFLYOBJECTPOOL_API UTireflyObjectPoolWorldSubsystem : public UWorldSubsystem
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "TireflyObjectPool")
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "TireflyObjectPool", Meta = (DisplayName = "Actor Pool Fetch Actor", DeterminesOutputType = "ActorClass"))
	...
	UFUNCTION(BlueprintCallable, Category = "TireflyObjectPool", Meta = (DisplayName = "Actor Pool Fetch Actors", DeterminesOutputType = "ActorClass"))
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "TireflyObjectPool", meta = (WorldContext = "WorldContext"
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "TireflyObjectPool", Meta = (DisplayName = "Actor Pool Release Actor"))
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "TireflyObjectPool", meta = (WorldContext = "WorldContextObject"))
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "TireflyObjectPool")
...
template <typename T>
T* UTireflyObjectPoolWorldSubsystem::ActorPool_FetchActor(TSubclassOf<T> ActorClass, FName ActorID)
{
...
template <typename T>
TArray<T*> UTireflyObjectPoolWorldSubsystem::ActorPool_FetchActors(TSubclassOf<T> ActorClass, FName ActorID,
	int32 Count)
{
...
template<typename T>
T* UTireflyObjectPoolWorldSubsystem::ActorPool_SpawnActor(TSubclassOf<T> ActorClass, FName ActorID
